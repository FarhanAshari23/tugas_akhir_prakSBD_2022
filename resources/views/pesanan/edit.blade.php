...
<div class="card mt-4">
	<div class="card-body">
		...
		<form method="post" action="{{ route('pesanan.update', $data->id_order) }}">
			@csrf
            <div class="mb-3">
                <label for="id_order" class="form-label">ID Pesanan</label>
                <input type="text" class="form-control" id="id_order" name="id_order" value="{{ $data->id_order }}">
            </div>
			<div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id_pembayaran" name="id_pembayaran" value="{{ $data->id_pembayaran }}">
            </div>
            <div class="mb-3">
